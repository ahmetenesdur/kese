...
import { type KeseWallet } from "./wallet.js";
/**
 ...
 */
export declare function poolContract(provider: RpcProvider, poolAddress: string): import("starknet").TypedContractV2<readonly [{
    readonly type: "impl";
...
export declare function buildWallet(options: BuildWalletOptions): LiveWallet;
